...
public class LoggedInPlayer {
    ...
    @OneToMany(mappedBy = "logged_in_player", fetch = FetchType.LAZY)
    @JsonIgnoreProperties(value = "logged_in_player")
    private List<Score> scores;

    public LoggedInPlayer(String name, String password) {
        this.name = name;
